...
func (t *Trade) MakeSwapTransactionCustom(poolKeys *layouts.ApiPoolInfoV4, amountIn *utils.TokenAmount, minAmountOut *utils.TokenAmount, feeConfig FeeConfig, customInstructions []solana.Instruction) (*solana.Transaction, error) {
	recent, err := t.Connection.GetLatestBlockhash(context.Background(), rpc.CommitmentFinalized)
	...
	instructions = append(instructions, customInstructions...)
